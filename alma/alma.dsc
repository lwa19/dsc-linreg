...
# Here we use the Alma 2011 paper structure
...
# Simulate data in the same way as section 4 of Alma 2011 (reg coeff = 5)
og_effects: og_effects.R
  $X:     X
  $y:     y
  #$Xtest: Xtest
  #$ytest: ytest
...
# Simulate data in the same way as section 4 of Alma 2011  
